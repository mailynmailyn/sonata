    ...
    <div className={classes.gridContainer}>
      ...
      <div className = {classes.gridContainer__createAcc}> 
        ...
        <form className={classes.gridContainer__createAcc__form}>
          <input type="text" className={classes.gridContainer__createAcc__text} value="email"></input>
          <input type="text" className={classes.gridContainer__createAcc__text} value="username"></input>
          <input type="text" className={classes.gridContainer__createAcc__text} value="password"></input>
          <input type="submit" className={classes.gridContainer__createAcc__button} value="register"></input>
        </form>
      </div>
    </div>
  );
