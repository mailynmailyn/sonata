...
function LoginPage({onLoginClick, onCreateAccClick}) {
  return (
    <div className={classes.gridContainer}>
      <div className = {classes.gridContainer__login}> 
        ...
        <form className={classes.gridContainer__login__form}>
          ...
          <input type="submit" className={classes.gridContainer__login__form__login} value="login" 
            onClick={() => onLoginClick()}></input>
        </form>
      </div>
      <div className = {classes.gridContainer__signUp}> 
        ...
        <button type="button" className={classes.gridContainer__signUp__button} 
          onClick={() => onCreateAccClick()}>register</button>
      </div>
    </div>
  );
}
